...
<div class="mx-auto max-w-screen-xl px-4 py-16 sm:px-6 lg:px-8">
    <div class="mx-auto max-w-lg text-center">
        <h1 class="text-2xl font-bold sm:text-3xl">Forgot Password - Wewin Event</h1>
    </div>

    <form action="../php/forgotpassword.php" method="POST" class="mx-auto mt-8 mb-0 max-w-md space-y-4">
        <div>
        ...
        <div>
            <button type="submit" class="w-full rounded-lg bg-blue-500 px-5 py-3 text-sm font-medium text-white">
                Reset Password
            </button>
        </div>
    </form>
