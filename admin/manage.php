    ...
    <div class="relative p-4 w-full max-w-md max-h-full">
        ...
        <div class="relative bg-white rounded-lg shadow">
            ...
            <div class="px-6 py-6 lg:px-8">
                <form method="post" action="../php/add_service.php" class="space-y-4" autocomplete="TRUE" enctype="multipart/form-data">
...
<script>
    function updateSubcategoryOptions() {
        ...
        if (categorySelect.value === "Wedding") {
            addOption(subcategorySelect, "Mahendi");
            addOption(subcategorySelect, "Haldi");
            addOption(subcategorySelect, "Vanarasam");
            addOption(subcategorySelect, "Mandap");
        } else if (categorySelect.value === "Birthday Parties") {
            addOption(subcategorySelect, "Children's Birthday");
            addOption(subcategorySelect, "Adult Birthday");
        }
    }
